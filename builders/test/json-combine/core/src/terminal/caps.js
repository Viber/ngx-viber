...
function getCapabilities(stream, isTerminalStream = !!stream && !!stream.isTTY) {
    console.log('--------------', stream);
...
exports.stdin = getCapabilities(process.stdin || stdio.stdin);
exports.stdout = getCapabilities(process.stdout || stdio.stdout);
exports.stderr = getCapabilities(process.stderr || stdio.stderr);
