...
const stdio = require('stdio-mock').stdio();
...
mock({
  'src/assets/json-merging-builder-test/source/a': {
    'lalala-xxx.json': '{"x1": {"x11": "x11x11x11", "x12": 12345, "x13": true, "x14": [1, "x1x1x1", 2], "x15": {"x1x11": "x12x12x12", "x1x12": {"x1x1x11": "x13x13x13"}}}}'
  }
});
...
describe('Combine', () => {
  ...
  // sinon.mock(process, 'stdin', stdin);
